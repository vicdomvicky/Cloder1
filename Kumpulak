clear
	...
	echo
	echo $pur"==================="$cy" ============================="
	echo $i"##"$me"  AUTHOR  :  Cloder        "$i"               ##"
	echo $i"##"$pu"  WhatsApp:  089504820459"$i"                  ##"
	echo $i"##"$pu"  YOUTUBE :  Cloder"$i"                        ##"
	echo $pur"==================="$cy" ============================="
	echo
	echo $cy"Cloder:"
	echo
	...
	echo
	echo $pur"Cloder["$pur"Tentukan pilihan kamu Sekarang"$pur"]"
	read -p"Cloder " pil
...
if [ $pil = 74 ]
	...
	sleep 2
	echo $ku"WAName   :"$i" Cloder"
	echo $ku"WhatsApp :"$i" 089504820459"
	sleep 2
	echo $pur"Terima kasih Yang Sudah Support dengan Tools ini"
	sleep 2
	echo $pur"SUBSCRIBE MY CHANNEL { Cloder }"
	exit
	fi
